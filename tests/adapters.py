...
from cs336_basics.training.optim.adam_w import AdamW
from cs336_basics.training.learning_rate_schedule import get_cosine_annealing_learning_rate_schedule
from cs336_basics.training.gradient_clipping import clip_gradient
from cs336_basics.training.data_loading import load_data
...
def run_multihead_self_attention(
    ...
    multihead_attention_layer.load_state_dict({'W_Q': q_proj_weight, 'W_K': k_proj_weight, 'W_V': v_proj_weight, 'W_O': o_proj_weight})
...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    multihead_attention_layer = MultiHeadSelfAttention(d_model, num_heads, with_rope=True, theta=theta, max_seq_len=max_seq_len, token_positions=token_positions)
    multihead_attention_layer.load_state_dict({'W_Q': q_proj_weight, 'W_K': k_proj_weight, 'W_V': v_proj_weight, 'W_O': o_proj_weight})
    return multihead_attention_layer(in_features)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return get_cosine_annealing_learning_rate_schedule(it, max_learning_rate, min_learning_rate, warmup_iters, cosine_cycle_iters)
